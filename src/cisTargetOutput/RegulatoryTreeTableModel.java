...
public class RegulatoryTreeTableModel extends AbstractTableModel {
	...
	public RegulatoryTreeTableModel(List<Motif> motifList){
    ...
    public Class<?> getColumnClass(int columnIndex) {
	  ...
	  protected void initColumnSizes(JTable table) {
		  RegulatoryTreeTableModel model = (RegulatoryTreeTableModel)table.getModel();
