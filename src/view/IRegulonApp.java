...
public class IRegulonApp extends AbstractCySwingApp {
    private static final String APPS_MENU = "Apps";
    ...
    * Start the plugin.
    */
    public IRegulonApp(CySwingAppAdapter adapter) {
        super(adapter);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            aboutText.setText(
                    "<html>" +
                            ...
                            "<b>Citation:</b> Rekin’s Janky, Annelien Verfaillie, Hana Imrichová, Bram Van de Sande, Laura Standaert, Valerie Christiaens, Gert Hulselmans, Koen Herten, Marina Naval Sanchez, Delphine Potier, Dmitry Svetlichnyy, Zeynep Kalender Atak, Mark Fiers, Jean-Christophe Marine, and Stein Aerts. <u>iRegulon: from a gene list to a gene regulatory network using large motif and track collections.</u> <i>Accepted in PLOS Computational Biology.</i>" + "<br/>" +
