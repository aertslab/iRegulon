            ...
            aboutText.setText(
                ...
                "<h2>Software License Agreement (hereinafter \"Agreement\")</h2>" +
                  ...
                  "<h3>Article 1 - Definitions</h3>" +
                    "<p><b>1.1</b> \"Software\" shall mean the iRegulon Cytoscape plugin as available on the website http://med.kuleuven.be/lcb/iRegulon and via the Cytoscape App Store as jar file. The software that you install is the client of a client-server system whereby the client sends a request to a web server (for example, running at the KU Leuven). The request consists of a list of genes (i.e., a list of nodes in a Cytoscape network), along with parameters. The client receives the results of the motif discovery and motif2TF mapping as a table with motifs, candidate transcription factors, and predicted target genes. These results can be used to 'annotate' the active Cytoscape networks, and can be saved as text or xml format.</p>" +
                    "<p><b>1.2</b> \"Effective Date\" shall mean the date on which you download or install the iRegulon Cytoscape plugin (as available on http://med.kuleuven.be/lcb/iRegulon and via the Cytoscape App store) on your system and which provide you access to the iRegulon webapplication.</p>" +
                  ...
                  "<h3>Article 9 - Miscellaneous</h3>" +
                    ...
                    "<p><b>9.1</b> The terms and conditions herein contained constitute the entire agreement between the Parties and supersede all previous agreements and understandings, whether oral or written, between the parties hereto with respect to the subject matter thereof.</p>" +
