...
echo 'track name=iRegulon_' . $feature . '_' . $target_gene_name . '_' . $transcription_factor .
     ' description="iRegulon enhancer location for transcription factor ' . $transcription_factor .
     ' and target gene ' . $target_gene_name . '" useScore=1' . "\n";
